...
public class DeleteUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(20, 240, 120, 40);
        ...
        user.setBounds(30, 130, 210, 26);

        jLabel5.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("مسح بيانات مستخدم");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(120, 30, 160, 22);

        jLabel2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("إسم المستخدم :");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(270, 130, 100, 30);
        ...
        jLabel3.setBounds(260, 240, 120, 40);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/atm/machine/delete.jpg"))); // NOI18N
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        int z = Class.DeleteUser(user.getText());
        if (z > 0) {
            JOptionPane.showMessageDialog(null, "تم حذف المستخدم بنجاح", "تمت العمليه بنجاح", 0, new ImageIcon("OIP_2.png"));
